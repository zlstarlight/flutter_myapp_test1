...
class StoreLanucher extends StatefulWidget {

  const StoreLanucher({Key? key}) : super(key: key);

  @override
  StoreLanucherState createState() => StoreLanucherState();
}

class StoreLanucherState extends State<StoreLanucher> {
